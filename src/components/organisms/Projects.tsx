...
const Projects = () => {
  return (
    <AnimatedSection id="projects" className="py-24 sm:py-32 bg-gradient-projects pt-20 pb-10 md:pt-24 md:pb-10">
      <div className="container mx-auto px-4 text-center">
        <Heading level={2} className="mb-12 text-foreground">Projelerim</Heading>
